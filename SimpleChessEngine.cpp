...
void generateInitialPosition(Board& board) {
    ...
    for (int i = 0; i < 8; i++) {
        ...
        *p1 = pw;
        *p2 = pb;
        board.getBoard()[1 * 8 + i] = p2;
        board.getBoard()[6 * 8 + i] = p1;
    }
    ...
    for (int i = 0; i < 2; i++) {
        ...
        *p1 = rw;
        *p2 = rb;
        board.getBoard()[i * 7] = p2;
        board.getBoard()[7 * 8 + i * 7] = p1;
    }
    ...
    for (int i = 0; i < 2; i++) {
        ...
        *p1 = kw;
        *p2 = kb;
        board.getBoard()[1 + i * 5] = p2;
        board.getBoard()[7 * 8 + 1 + i * 5] = p1;
    }
    ...
    for (int i = 0; i < 2; i++) {
        ...
        *p1 = bw;
        *p2 = bb;
        board.getBoard()[2 + i * 3] = p2;
        board.getBoard()[7 * 8 + 2 + i * 3] = p1;
    }
